...
def get_processed_dataframes():
    """
        Assumes the proper modifications in the preprocessing step. Refer to the ipython note book
...
def squeeze_model_52():
    ...
    model.compile(optimizer=Adam(lr=LEARNING_RATE, decay=0.001, amsgrad=True), loss='mse')
    return model
